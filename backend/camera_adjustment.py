...
def reset_camera_settings():
    camera.framerate = camera_defaults['framerate']
    camera.sensor_mode = camera_defaults['sensor_mode']
    camera.shutter_speed = camera_defaults['shutter_speed']
    camera.iso = camera_defaults['iso']
    camera.exposure_mode = camera_defaults['exposure_mode']
    camera.awb_gains = camera_defaults['awb_gains']
